<template>
  <div>
      ...
      <el-col :span="16">
        <div class="category-tree-content grid-content bg-purple-light">
          ...
          <div class="btn_bottom">
            ...
            <el-button @click="addDefault" :disabled="addFalse">新增默认商品</el-button>
    ...
    <el-dialog :title="name" :visible.sync="commodityChoice" v-if="commodityChoice" width="70%" height="70%" top="3%"
               :close-on-click-modal="false" :append-to-body="true">
      <commodity v-on:commodityData="commodityData"  :mall="formInline.mall_id" :commdityType="commdityType" :productId="commdityId"></commodity>
    </el-dialog>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
      ...
      viewRow(row) {
        ...
        this.commdityId = row.product_id;
