...
export default {
  ...
  methods: {
    ...
    deleteRow(index, row) { // 作废
      common.del('此操作将作废该品牌是否继续', 'brand_info/editBrand', { brand_id: row[index].brand_id, enabled: 0 }, 'brand_info/getBrandList', this,'brandSearch');
    },
    startRow(index, row) { // 启用
      common.del('此操作将启用该品牌是否继续', 'brand_info/editBrand', { brand_id: row[index].brand_id, enabled: 1 }, 'brand_info/getBrandList', this,'brandSearch');
    },
