    ...
    <el-row>
      ...
      <el-col :span="16">
        <div v-if= "contentIsShow" class="category-tree-content grid-content bg-purple-light">
          <p class="category-text">品类信息 <span v-if="contentIsShow" class="addCategory" @click="addCategory">添加子类</span></p>
...
import EditCategory from '@/components/basic/editCategory.vue';
import AddCategory from '@/components/basic/addCategory.vue';
...
export default {
  ...
  created() {
    building.getBtnList(this.btn.getUrlList(this.$route), this);
    this.loading = true;
