  ...
  <el-main>
    <el-form ref="form" :model="formInline" label-width="80px" class="search">
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item label="订单起止日期" class="width_110">
            <el-date-picker
              v-model="start_date"
      ...
      <el-row v-show="formShow">
        <el-col :span="6">
          <el-form-item label="导购姓名">
            <el-input v-model="formInline.name" placeholder="请输入公司名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="导购电话">
            <el-input v-model="formInline.mobile" placeholder="请输入公司名称"></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="6">
  ...
  export default {
    ...
    methods: {
      ...
      pagination(val) {
        ...
        common.set('orderSearch', { 'search': dataSearch })
      },
      ...
      determineClick(formName) {
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            that.http.post('OrderMain/editOrder',  {
