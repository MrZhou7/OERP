<template>
  <el-main>
    ...
    <div class="btn_bottom">
      ...
      <el-button :disabled="batch" @click="batchEnabling">启用</el-button>
      <el-button :disabled="batch" @click="batchStop">停用</el-button>
      <el-button :disabled="batch" @click="batchDelete">删除</el-button>
      <el-button  :disabled="batch" @click="batchReset">重置密码</el-button>
    </div>
      ...
      <el-table
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            ...
            <el-button v-if="scope.row.enabled == 1" style="color:red" type="text" size="small" @click.native.prevent="startRow(scope.row,0)">停用</el-button>
