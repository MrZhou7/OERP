<template>
  <el-main>
    ...
    <el-dialog :title="createName" :visible.sync="entry.createChoice" v-if="entry.createChoice" width="100%" height="100%" top="0%" :close-on-click-modal="false">
      <create v-on:createData="createData" :createDataTypeId="createDataTypeId" :createDataType="createDataType"></create>
    </el-dialog>
  </el-main>
</template>
...
<script>
  ...
  import create from '@/components/contract/create.vue' //合同
  export default {
    components: {
      category,
      brand,
    ...
    data() {
      return {
        ...
        currentPage: 1,//当前页码
        pageSize:20,
        tableHeight: window.innerHeight - 345, //表格高度
        checkData: {}, //选中数据
    ...
    methods: {
      ...
      changFun(row) {//获取选择数据
        ...
        this.checkData = row;
        common.changFun(row,rowOne,rowTwo,this)
      ...
      addRow() {
        ...
        //   }
        // })
        this.entry.createChoice = true;
        this.createDataTypeId = '';
        this.createDataType = 'add';
        this.createName = '新增合同';
      },
      viewRow(row) {
        // this.$router.push({
        //   path: '/contract/create',
        ...
        //   query: {
        //     status: 'view',
        //     type: row.contract_main_id
        //   }
        // })
        this.entry.createChoice = true;
        this.createDataTypeId = row.contract_main_id;
        this.createDataType = 'view';
        this.createName = '查看合同';
      },
      editRow(row) {
        // this.$router.push({
        //   path: '/contract/create',
        ...
        this.entry.createChoice = true;
        this.createDataTypeId = row.contract_main_id;
        this.createDataType = 'edit';
        this.createName = '编辑合同';
      },
